<template>
  <div :class="`n-tabs ${size}`">
    <div class="n-tabs-nav">
      <div ref="wrap" class="n-tabs-nav-wrap" :class="{ 'tabs-center': centered, 'before-shadow-active': scrollLeft > 0, 'after-shadow-active': scrollLeft < scrollMax }">
        <div ref="nav" class="n-tabs-nav-list" @wheel="showWheel ? onWheel($event) : () => false" :style="`transform: translate(${-scrollLeft}px, 0)`">
          <div
            ref="tabs"
            class="u-tab"
    ...
    <div class="n-tabs-page">
      <div class="n-tabs-content" v-show="activeKey === page.key" v-for="page in tabPages" :key="page.key">
...
watchEffect(
  () => {
    // 若想要侦听器回调中能访问被 Vue 更新之后的 DOM，你需要指明 flush: 'post' 选项
