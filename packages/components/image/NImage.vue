<template>
  <div class="n-image-wrap">
    ...
    >
      <n-loading :loading="!complete[index]" indicator="dynamic-circle">
      ...
      <div class="n-image-mask" @click="onPreview(index)" v-if="previewMode">
        <div class="n-image-mask-info">
    ...
    <Transition name="mask">
      <div class="n-preview-mask" v-show="showPreview"></div>
    </Transition>
    <Transition name="preview">
      <div class="n-preview-wrap" v-show="showPreview" @click.self="onClose" @wheel.prevent="onWheel">
        <div class="n-preview-body">
          <div class="n-preview-operations">
          ...
          <div class="n-preview-image" :style="`transform: translate3d(${dragX}px, ${dragY}px, 0px);`">
            <n-loading :loading="!loaded[index]" indicator="dynamic-circle" v-show="previewIndex === index" v-for="(image, index) in images" :key="index">
              <img
          ...
          <template v-if="imageCount > 1">
            <div class="n-switch-left" :class="{ 'u-switch-disabled': previewIndex === 0 && !loop }" @click="onSwitchLeft">
            ...
            <div class="n-switch-right" :class="{ 'u-switch-disabled': previewIndex === imageCount - 1 && !loop }" @click="onSwitchRight">
