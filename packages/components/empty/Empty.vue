...
<template>
  <div class="n-empty">
    <svg class="u-empty-1" :style="imageStyle" v-if="image === '1'" viewBox="0 0 184 152" xmlns="http://www.w3.org/2000/svg">
    ...
    <svg class="u-empty-2" :style="imageStyle" v-else-if="image === '2'" viewBox="0 0 64 41" xmlns="http://www.w3.org/2000/svg">
