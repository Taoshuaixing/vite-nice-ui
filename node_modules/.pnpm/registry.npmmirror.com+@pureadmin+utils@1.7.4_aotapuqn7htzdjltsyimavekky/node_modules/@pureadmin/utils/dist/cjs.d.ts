 ...
 * color.ts
 */
declare type ColorType = "rgb" | "hex" | "hsl";
 ...
 * debounce.ts
 */
declare type TimeoutHandle = ReturnType<typeof setTimeout> | null;
 ...
 * @param "copy"  拷贝
 */
declare type MouseEvent = "contextmenu" | "selectstart" | "copy";
/**
 * link.ts
 ...
 */
declare type Target = "_blank" | "_self" | "_parent" | "_top" | "framename";
/**
 * packageSize.ts
 */
 ...
 * useEcharts.ts
 */
declare type ToolTipType = "x" | "y" | true;
 ...
 * @returns 绝对路径
 */
declare function getAbsolutePath(path: string): string;
...
export { AppendDataOpts, ArgumentsType, Arrayable, AttrParams, Awaitable, BrowserType, ColorOptions, ColorType, ComponentElRef, ComponentRef, Constructor, DataURL, DeepMerge, DeviceType, EchartOptions, ElRef, ElementOf, EventParams, Fn, FunctionArgs, GlobalUtilsPropertiesApi, LoadOpts, LoadType, MergeInsertions, MouseEvent, Nullable, OptionsParams, OptionsScript, Performance, ProxyStorage, ReadonlyRecordable, Recordable, RefType, Target, Theme, TimeoutHandle, ToolTipType, UnionToIntersection, UtilsEChartsOption, addZero, addition, appendFieldByUniqueId, attr, average, bd09togcj02, buildHierarchyTree, buildPrefixUUID, buildUUID, centsToDollars, clone, convertPath, createYear, currentDateOpt, currentDateType, darken, dataURLtoBlob, dateType, debounce, delay, deleteChildren, divisionOperation, dollarsToCents, downloadByBase64, downloadByData, downloadByOnlineUrl, downloadByUrl, exceedMathMax, extractPathList, formDataHander, formatBytes, gcj02tobd09, gcj02towgs84, getAbsolutePath, getCurrentDate, getCurrentWeek, getDecimalPlaces, getNodeByUniqueId, getPackageSize, gradientType, handleTree, hasCNChars, hasOwnProp, hexToRgb, is, isAlphabets, isArray, isBase64, isBoolean, isClient, isDate, isDef, isElement, isEmail, isEmpty, isEqual, isEqualArray, isEqualObject, isExistSpace, isFunction, isHex, isIncludeAllChildren, isJSON, isLeapYear, isLowerCase, isNull, isNullAndUnDef, isNullOrUnDef, isNumber, isObject, isParams, isPhone, isPostCode, isPromise, isQQ, isRegExp, isRgb, isRgba, isServer, isString, isUnDef, isUpperCase, isUrl, isWindow, lighten, max, min, monthDays, multiplication, nameCamelize, nameHyphenate, numberToChinese, openLink, out_of_china, packageOpt, priceToThousands, priceUppercase, randomColor, removeAllSpace, removeBothSidesSpace, removeLeftSpace, removeRightSpace, rgbToHex, splitNum, subAfter, subBefore, subBetween, subBothSides, subTextAddEllipsis, subtraction, sum, throttle, urlToBase64, uuid, wgs84togcj02 };
