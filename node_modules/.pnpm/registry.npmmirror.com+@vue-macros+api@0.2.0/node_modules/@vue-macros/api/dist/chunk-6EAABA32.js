...
async function getTSFile(filePath) {
  ...
  const program = _common.babelParse.call(void 0, 
    await _promises.readFile.call(void 0, filePath, "utf-8"),
    _common.getLang.call(void 0, filePath)
  );
  return tsFileCache[filePath] = {
    filePath,
    content,
...
var isTSDeclaration = (node) => _types.isDeclaration.call(void 0, node) && node.type.startsWith("TS");
