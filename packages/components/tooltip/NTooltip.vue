...
import { ref } from 'vue'
import { rafTimeout, cancelRaf } from '../../utils/index'
interface Props {
...
<template>
  <div class="n-tooltip" @mouseenter="onShow" @mouseleave="onHide">
    <div ref="titleRef" class="n-title" :class="{ 'show-tip': visible }" @mouseenter="onShow" @mouseleave="onHide" :style="`max-width: ${maxWidth}px; top: ${-top}px; left: ${-left}px;`">
